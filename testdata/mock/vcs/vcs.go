...
//
//	mockgen -destination ../../testdata/mock/vcs/vcs.go -source vcs.go
//
...
func (mr *MockSystemMockRecorder) CanFetch(path any) *gomock.Call {
...
func (mr *MockSystemMockRecorder) FetchPath(ctx, path any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSystemMockRecorder) FetchURL(ctx, url any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBasicAuthentifierMockRecorder) BasicAuth(host any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientChooserMockRecorder) AllowInsecure(path any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientChooserMockRecorder) ClientFor(path any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
