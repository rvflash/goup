...
//
//	mockgen -destination ../../testdata/mock/mod/file.go -source file.go
//
...
func (mr *MockModMockRecorder) UpdateReplace(oldPath, newVersion any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockModMockRecorder) UpdateRequire(path, version any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
